...
wget --no-verbose -c https://almond-static.stanford.edu/test-data/models/genienlp-v0.6.0a1.tar.xz -O $srcdir/tests/embeddings/genienlp-v0.6.0a1.xz
tar xvf $srcdir/tests/embeddings/genienlp-v0.6.0a1.xz -C 'models/org.thingpedia.models.contextual:en'
